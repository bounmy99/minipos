          ...
          <div class="authentication-wrapper authentication-basic container-p-y col-md-4 ">
            ...
            <!-- Register -->
              <div class="card">
                ...
                <!-- /Logo -->
                <h4 class="mb-2 d-flex justify-content-center">ຍິນດີຕ້ອນຮັບ</h4>
                ...
                <form id="formAuthentication" class="mb-3" action="index.html" method="POST">
                    ...
                    <div class="mb-3">
                    <label for="email" class="form-label size">ອີ່ເມວ</label>
                    <input type="text" class="form-control" placeholder="ກະລຸນາປ້ອນອີເມວ" v-model="email">
                    </div>
                    <div class="mb-3 form-password-toggle">
                    <div class="d-flex justify-content-between">
                    <label class="form-label size" for="password">ລະຫັດຜ່ານ</label>
                    </div>
